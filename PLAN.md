...
| `dx_catalog` provider/model archive | 5/100 | `rkyv` + `memmap2` catalog loader/generator powers model picker and routing | Implement archived structs and loader |
...
Overall implementation status: 18/100.
