...
| `dx_catalog` provider/model archive | 70/100 | `rkyv` + `memmap2` catalog loader/generator powers model picker and routing | Add concrete model-catalog parsers for models.dev/OpenRouter/LiteLLM and wire generated artifacts into the Agent model picker |
...
Overall implementation status: 42/100.
