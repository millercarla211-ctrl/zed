...
| `dx_catalog` provider/model archive | 44/100 | `rkyv` + `memmap2` catalog loader/generator powers model picker and routing | Connect adapters to real G-drive Flow, `zeroclaw-providers`, models.dev, LiteLLM, OpenRouter, and local model scan data |
...
Overall implementation status: 30/100.
