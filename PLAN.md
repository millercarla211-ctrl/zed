...
| `dx_catalog` provider/model archive | 78/100 | `rkyv` + `memmap2` catalog loader/generator powers model picker and routing | Wire generated catalog artifacts into the Agent model picker and route selection |
...
Overall implementation status: 46/100.
