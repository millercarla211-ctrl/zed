...
| `dx_catalog` provider/model archive | 22/100 | `rkyv` + `memmap2` catalog loader/generator powers model picker and routing | Add generator inputs from Flow, `zeroclaw-providers`, models.dev, LiteLLM aliases, and local llama.cpp scans |
...
Overall implementation status: 22/100.
