...
| Codex-style rails | 33/100 | Left Sources and right project/task rail are optional, cheap when closed, and backed by receipt-producing Agent actions | Add compact rail controls and guided proof cards |
| Launch demo package | 44/100 | May 22 sprint demos show speed, local model tools, provider freedom, metasearch, receipt chains, and panels | Add media/Forge guided proof cards and runtime proof |

Overall implementation status: 100/100 for the completed launch-spine set.

Current next 100-point feature set status: 74/100 for DX Native Tool Execution, Restore, Panels, and Launch Demos.
