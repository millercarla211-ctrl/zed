...
| `dx_catalog` provider/model archive | 32/100 | `rkyv` + `memmap2` catalog loader/generator powers model picker and routing | Wire concrete generator adapters for Flow, `zeroclaw-providers`, models.dev, LiteLLM aliases, and local llama.cpp scans |
...
Overall implementation status: 26/100.
