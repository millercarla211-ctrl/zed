...
- The standard DX receipt-cache root/summary/kind-summary/health contract and Binary Cache rail consumption path have formatting/diff/conflict/source-reference validation only so far; governed producer execution, artifact round-trip proof, Cargo checks, `just run`, and performance measurements remain deferred under the repo's launch validation rules.
