...
- Added Binary Cache rail artifact-review status so malformed, expired, partial, missing-root, or unknown receipt-cache artifact states route operators to regenerate metadata-only artifacts while keeping JSON receipts authoritative.
