...
- The standard DX receipt-cache root contract has formatting/diff/conflict/source-reference validation only so far; governed producer execution, artifact round-trip proof, Cargo checks, `just run`, and performance measurements remain deferred under the repo's launch validation rules.
