...
pub(crate) const AGENT_PLUGIN_FINAL_RUNTIME_HEADROOM_CLEANUP_RESULT_STATUS_SCHEMA: &str =
...
pub(crate) const WEBPREVIEW_MANAGED_CHROME_ACTION_CARD_DISPLAY_SCHEMA: &str =
    "zed.web_preview.managed_chrome_action_card_display.v1";
pub(crate) const WEBPREVIEW_PC_USE_PROOF_CARD_SCHEMA: &str = "zed.web_preview.pc_use_proof_card.v1";
...
pub(crate) const AGENT_PLUGIN_PC_USE_PROOF_SUMMARY_SCHEMA: &str =
    "zed.agent_plugins.pc_use.proof_summary.v1";
