...
fn workflow_recipes() -> Value {
    serde_json::json!({
        ...
        "chrome_managed_playwright_safe_actions": {
            ...
            "safe_for": ["open_url", "screenshot", "inspect_element", "set_viewport", "wait_for_selector"],
    ...
    serde_json::json!({
        ...
        "managed_chrome": {
            ...
            "cases": [
                ...
                "compose and queue open_url, screenshot, inspect_element, set_viewport, and wait_for_selector payloads",
