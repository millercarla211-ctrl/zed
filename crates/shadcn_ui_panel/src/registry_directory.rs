// Generated from https://ui.shadcn.com/r/registries.json.
// This mirrors the public shadcn registry directory for offline browsing inside Zed.
...
pub const COMMUNITY_REGISTRIES: &[CommunityRegistry] = &[
    CommunityRegistry {
        name: "@8bitcn",
    ...
    CommunityRegistry {
        ...
        description: "A small collection of focused, production\u{2011}ready components and primitives for React/Next.js projects\u{2014}built on shadcn/ui and complementary libraries.",
    },
    CommunityRegistry {
        name: "@agents-ui",
    ...
    CommunityRegistry {
        ...
        description: "Cult UI is a rare, curated set of shadcn-compatible, headless and composable components\u{2014}tastefully animated with Framer Motion.",
    },
    CommunityRegistry {
        name: "@darx",
    ...
    CommunityRegistry {
        ...
        description: "A shadcn registry for AI and media-rich interfaces \u{2014} streaming LLM chat, zoomable images, swipeable card decks, interactive maps, plus dashboard and landing-page blocks.",
    },
    CommunityRegistry {
        name: "@devl",
    ...
    CommunityRegistry {
        ...
        description: "Opinionated, accessible components on Base UI and shadcn-style primitives \u{2014} starting with a Creatable Combobox.",
    },
    CommunityRegistry {
        name: "@fluid",
    ...
    CommunityRegistry {
        ...
        description: "UX4G 2.0 design system for India \u{2014} many accessible React components and an 8-color theme preset for native apps.",
    },
    CommunityRegistry {
        name: "@inferencesh",
    ...
    CommunityRegistry {
        ...
        description: "LMS components for building interactive learning experiences \u{2014} quiz, flashcards, matching, fill-in-the-blank, word scramble, sequencing, reading comprehension, spaced repetition and more.",
    },
    CommunityRegistry {
        name: "@loading-ui",
    ...
    CommunityRegistry {
        ...
        description: "Composable React components powered by Base UI and Tailwind CSS \u{2014} Build fast, customize everything.",
    },
    CommunityRegistry {
        name: "@lytenyte",
    ...
    CommunityRegistry {
        ...
        description: "Unified payments SDK for builders \u{2014} handle checkout, billing, and webhooks across Stripe, PayPal, Adyen, and regional gateways with a single integration.",
    },
    CommunityRegistry {
        name: "@phucbm",
    ...
    CommunityRegistry {
        ...
        description: "A collection of beautifully crafted motion components built with React, Framer Motion, and TailwindCSS. Designed to elevate microinteractions, each component focuses on smooth animations, subtle feedback, and delightful UX. Perfect for designers and developers who want to add refined motion to their interfaces \u{2014} copy, paste, and make your UI come alive.",
    },
    CommunityRegistry {
        name: "@solaceui",
    ...
    CommunityRegistry {
        ...
        description: "A shadcn/ui registry with EchoText (`echo-text`): layered stroke text that follows the pointer\u{2014}minimal setup, drop-in component.",
    },
    CommunityRegistry {
        name: "@thegridcn",
    ...
    CommunityRegistry {
        ...
        description: "UI Layouts offers components, effects, design tools, and ready-made blocks that make building modern interfaces more efficient\u{2014}built with React, Next.js, Tailwind CSS, and shadcn/ui.",
    },
    CommunityRegistry {
        name: "@uicapsule",
